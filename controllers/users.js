...
exports.forget=async(req,res)=>{
    try{
        ...
        msg_type:"error",})// render is function with 2 parameters
            ...
            const newPassword = await bcrypt.hash(password,8); // You can get this from req.body or another source
            db.query("UPDATE users SET PASS = ? WHERE email = ?", [newPassword, email], (updateError, updateResult) => {
            if (updateError) {
